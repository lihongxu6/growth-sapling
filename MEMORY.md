...
- ✅ **v2.0.1 已提交审核（2026-07-20，用户操作）**：含方案B日历配色+未来日白底+活跃任务口径对齐+补卡完成庆祝弹窗；因 `wx.chooseImage` 触发相册(Album)隐私接口，提交前已按 #57 在《隐私保护指引》声明相册+摄像头（否则平台拦截/发布后回收权限）；审核队列 1-7 天，结果待用户告知。
