...
41. 🔜 **日历配色修复（方案 B + 未来日白底 + 活跃任务口径对齐，2026-07-20）**：用户真机发现「有任务0完成」日显示白底，已按方案 B 修复（黄/橙/绿+补字）；后续复核又发现未来日期不应着色，已追加「未来日期统一白底」逻辑；再后续发现 7月13日 日历绿但点进去还有未完成，已修复为「日历分母/分子与打卡页当天活跃任务口径一致」。25/25 自测 ✅、compile ✅、preview 重出 ✅、已 commit+push。⚠️ 仍需用户：① 重新 `upload` 新版本（2.0.1）+ ② 微信公众平台再次提交审核；③ 确认《隐私保护指引》已声明相册/摄像头（#57）。详见 §3.15 第八/九/十轮 + #58 + #59 + #60 + 验收报告第十五/十六/十七节。
