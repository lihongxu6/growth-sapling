...
25. 🚀 流程推进（2026-07-18）：用户确认 v2.0 我的成长页用户信息合并设计稿；已同步 PRD/tech-spec v2.0 章节（删独立「我的」页、入口改为「我的成长」页就地点改）。待 commit 设计稿（`ui-mockup-v2-userinfo.html` + `v2-userinfo-design-preview.png`）后进入研发。
